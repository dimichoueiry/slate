...
export const ICON_CATEGORIES: IconCategory[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      I('piano', 'Piano', 'keys music instrument', 'M3 4 h18 v16 H3 Z', 'M7.5 13 V20', 'M12 13 V20', 'M16.5 13 V20', 'M6.4 4 h2.2 v6.5 h-2.2 Z', 'M10.9 4 h2.2 v6.5 h-2.2 Z', 'M15.4 4 h2.2 v6.5 h-2.2 Z'),
      I('vinyl', 'Vinyl', 'record music dj retro', cir(12, 12, 9), cir(12, 12, 3), cir(12, 12, 0.9)),
      I('drum', 'Drum', 'percussion music beat', 'M4 8 a8 3.2 0 1 0 16 0 a8 3.2 0 1 0 -16 0', 'M4 8 V16.5 a8 3.2 0 0 0 16 0 V8', 'M6 2.5 L13 7', 'M18 2.5 L11 7'),
      I('radio', 'Radio', 'broadcast fm music', 'M3 8 h18 v12 H3 Z', 'M5.5 8 L17 3.5', cir(8, 14, 2.6), 'M14 12 h4.5', 'M14 15 h4.5'),
    ],
  },
  {
    id: 'files',
  ...
  },
  {
    ...
    icons: [
      ...
      I('thermometer', 'Thermometer', 'temperature weather heat', 'M10.5 3.5 a1.5 1.5 0 0 1 3 0 V13 a4 4 0 1 1 -3 0 Z', cir(12, 16.8, 1.5), 'M12 13 v2'),
      I('sunrise', 'Sunrise', 'morning dawn weather sun', 'M7.5 14 a4.5 4.5 0 0 1 9 0', 'M12 6 V3.5', 'M5.6 8.6 L7 10', 'M18.4 8.6 L17 10', 'M3 14 H21', 'M6 18 H18'),
      I('fog', 'Fog', 'mist weather cloud haze', 'M7 13.5 a4.5 4.5 0 1 1 .9 -8.9 A6 6 0 0 1 19 6.5 a3.5 3.5 0 0 1 -1 7', 'M5 17 H15', 'M9 20.5 H19'),
      I('tornado', 'Tornado', 'storm wind weather twister', 'M4 5 H20', 'M6 8.5 H18', 'M8 12 H15.5', 'M10 15.5 H14', 'M11.5 19 H13'),
    ],
  },
  {
    id: 'food',
  ...
  },
  {
    ...
    icons: [
      I('cart', 'Cart', 'shop buy ecommerce checkout', 'M2.5 3.5 H5 L7.5 15.5 H18.5 L21 7 H6.2', cir(9.3, 19, 1.7), cir(16.8, 19, 1.7)),
      I('basket', 'Basket', 'shop market groceries', 'M4 10 H20 L18.5 20 H5.5 Z', 'M8 10 L12 3.5 L16 10', 'M9.5 13 v4', 'M12 13 v4', 'M14.5 13 v4'),
      I('credit-card', 'Card', 'payment credit debit money', 'M2.5 5 h19 v14 h-19 Z', 'M2.5 9.5 H21.5', 'M6 15.5 h4'),
      I('wallet', 'Wallet', 'money cash payment', 'M3 7 a2 2 0 0 1 2 -2 H17', 'M3 7 V18 a2 2 0 0 0 2 2 h14 a2 2 0 0 0 2 -2 V10 a2 2 0 0 0 -2 -2 H5 A2 2 0 0 1 3 7', cir(16.5, 14, 1.2)),
      I('piggy', 'Savings', 'piggy bank save money', 'M4.5 13.5 a7 7 0 0 1 13.4 -2.8 c1.3 .3 2.1 1 2.6 2.3 h1 v3 h-1.6 c-.4 1 -1 1.8 -1.9 2.5 V21 h-2.5 l-.6 -1.6 h-3.8 L10.5 21 H8 v-2.6 A7 7 0 0 1 4.5 13.5 Z', cir(15.5, 11, 0.7), 'M10 6.8 l3.5 -1'),
      I('bank', 'Bank', 'finance institution money', 'M3 9 L12 3.5 L21 9 Z', 'M5 9 V17', 'M9.7 9 V17', 'M14.3 9 V17', 'M19 9 V17', 'M3 17 H21', 'M2.5 20 H21.5'),
      I('safe', 'Safe', 'vault secure money', 'M4 4 h16 v16 H4 Z', cir(12, 12, 4), cir(12, 12, 1.2), 'M12 8 V6.5', 'M12 17.5 V16', 'M8 12 H6.5', 'M17.5 12 H16'),
      I('coins', 'Coins', 'money change cash', cir(9, 9, 5.5), cir(15, 15, 5.5)),
      I('receipt', 'Receipt', 'invoice bill purchase', 'M5 3 h14 v18 l-2.3 -1.8 -2.3 1.8 -2.4 -1.8 -2.3 1.8 -2.4 -1.8 L5 21 Z', 'M9 8 H15', 'M9 12 H15'),
      I('barcode', 'Barcode', 'scan product code', 'M4 6 V18', 'M6.5 6 V18', 'M10 6 V18', 'M12 6 V18', 'M15.5 6 V18', 'M18 6 V18', 'M20 6 V18'),
      I('qr-code', 'QR code', 'scan link code', 'M4 4 h6 v6 H4 Z', 'M14 4 h6 v6 h-6 Z', 'M4 14 h6 v6 H4 Z', cir(7, 7, 1), cir(17, 7, 1), cir(7, 17, 1), 'M14 14 h3', 'M20 14 v3', 'M14 20 h3', 'M17.5 16.5 h2.5'),
      I('delivery', 'Delivery', 'truck shipping logistics', 'M2.5 6 h12 V16 H2.5 Z', 'M14.5 9.5 H19 L21.5 13 V16 H14.5', cir(6.5, 18, 1.8), cir(17.5, 18, 1.8)),
      I('tag-sale', 'Sale', 'discount percent price', 'M3.5 3.5 H11 L20.5 13 L13 20.5 L3.5 11 Z', cir(8, 8, 1.3), 'M9 14.5 L14.5 9', cir(13.5, 13.5, 1.1)),
      I('balance', 'Balance', 'scale justice compare weigh', 'M12 4 V20', 'M4.5 7 H19.5', 'M4.5 7 L2.5 12.5', 'M4.5 7 L6.5 12.5', 'M1.8 12.5 a2.7 2.7 0 0 0 5.4 0', 'M19.5 7 L17.5 12.5', 'M19.5 7 L21.5 12.5', 'M16.8 12.5 a2.7 2.7 0 0 0 5.4 0', 'M8.5 20 H15.5'),
    ],
  },
  {
    id: 'devices',
    label: 'Devices',
    icons: [
      I('monitor', 'Monitor', 'screen display desktop', 'M3 4 h18 v12 H3 Z', 'M12 16 v4', 'M8.5 20 h7'),
      I('keyboard', 'Keyboard', 'typing keys input', 'M2.5 7 h19 v10 h-19 Z', 'M5 10.5 h1.4', 'M8 10.5 h1.4', 'M11 10.5 h1.4', 'M14 10.5 h1.4', 'M17.6 10.5 h1.4', 'M8 14 H16'),
      I('mouse-device', 'Mouse', 'click cursor input', 'M8 7 a4 4 0 0 1 8 0 V17 a4 4 0 0 1 -8 0 Z', 'M12 6 v3.5'),
      I('printer', 'Printer', 'print paper office', 'M7 8 V3.5 H17 V8', 'M3.5 8 h17 v8 h-17 Z', 'M7 13 h10 v7.5 H7 Z', cir(17.5, 10.5, 0.7)),
      I('speaker', 'Speaker', 'audio sound music', 'M6 3 h12 v18 H6 Z', cir(12, 14.5, 3.5), cir(12, 7.5, 1.2)),
      I('smartwatch', 'Smartwatch', 'wearable time device', 'M7.5 6.5 h9 v11 h-9 Z', 'M9.5 6.5 L10 2.5 h4 l.5 4', 'M9.5 17.5 L10 21.5 h4 l.5 -4', 'M12 10.5 v2 l1.5 1'),
      I('power-plug', 'Power plug', 'outlet electric charge', 'M9 2.5 V8', 'M15 2.5 V8', 'M6.5 8 h11 v3 a5.5 5.5 0 0 1 -11 0 Z', 'M12 16.5 V18.5 a2.5 2.5 0 0 1 -5 .5'),
      I('bluetooth', 'Bluetooth', 'wireless pairing connect', 'M6.5 7 L17.5 17 L12 21.5 V2.5 L17.5 7 L6.5 17'),
      I('usb', 'USB', 'connector port drive', 'M12 3 V18', cir(12, 20, 1.8), 'M12 12 L7 9.5 V7', cir(7, 6, 1), 'M12 15 L17 12.5 V10', 'M16 8 h2 v2 h-2 Z', 'M12 3 L10.5 5.5 h3 Z'),
      I('webcam', 'Webcam', 'camera video meeting', cir(12, 10, 6.5), cir(12, 10, 2.5), 'M12 16.5 v1.5', 'M6.5 21 a7 7 0 0 1 11 0'),
      I('battery-charge', 'Charging', 'battery power energy', 'M2.5 9 h17 v7.5 h-17 Z', 'M21.5 11.5 v2.5', 'M12.8 9.8 L10.2 13 h3.4 L11 16.2'),
      I('flashlight', 'Flashlight', 'torch light beam', 'M8 3 h8 v3.5 L14 10 V21 h-4 V10 L8 6.5 Z', cir(12, 13, 1)),
    ],
  },
  {
    id: 'office',
    label: 'Office & Work',
    icons: [
      I('briefcase', 'Briefcase', 'work job business career', 'M3 8 h18 v12 H3 Z', 'M9 8 V5.5 h6 V8', 'M3 13 H21'),
      I('presentation', 'Presentation', 'pitch deck meeting', 'M3 3.5 H21', 'M4.5 3.5 h15 V14 h-15 Z', 'M8 11.5 V9', 'M12 11.5 V6.5', 'M16 11.5 V8', 'M12 14 v2.5', 'M9 20.5 L12 16.5 L15 20.5'),
      I('whiteboard', 'Whiteboard', 'board meeting brainstorm', 'M3 4 h18 v12 H3 Z', 'M6 9 c2 -2.5 4 2.5 6 0 c1.3 -1.6 2.7 -1 4 0', 'M6 12.5 H13', 'M7.5 20 L10 16', 'M16.5 20 L14 16'),
      I('stamp-tool', 'Stamp', 'approve seal official', 'M5 21.5 H19', 'M4.5 18 V16.5 A2.5 2.5 0 0 1 7 14 h10 a2.5 2.5 0 0 1 2.5 2.5 V18 Z', 'M14 14 V9.5 C14 8 15 7.8 15 6 a3 3 0 0 0 -6 0 c0 1.8 1 2 1 3.5 V14'),
      I('mail-open', 'Open mail', 'email read message', 'M3 9.5 L12 3.5 L21 9.5 V20 H3 Z', 'M3 9.5 L12 15 L21 9.5'),
      I('folder-plus', 'New folder', 'add directory create', 'M3 6.5 a1.5 1.5 0 0 1 1.5 -1.5 H9 l2.5 2.5 H19.5 A1.5 1.5 0 0 1 21 9 V18 a1.5 1.5 0 0 1 -1.5 1.5 h-15 A1.5 1.5 0 0 1 3 18 Z', 'M12 11.5 V16', 'M9.75 13.75 H14.25'),
      I('org-chart', 'Org chart', 'hierarchy team structure', 'M9.5 3 h5 v4 h-5 Z', 'M12 7 V10.5', 'M5.5 10.5 H18.5', 'M5.5 10.5 V13.5', 'M18.5 10.5 V13.5', 'M12 10.5 V13.5', 'M3 13.5 h5 v4 H3 Z', 'M9.5 13.5 h5 v4 h-5 Z', 'M16 13.5 h5 v4 h-5 Z'),
    ],
  },
  {
    id: 'sports',
    label: 'Sports & Games',
    icons: [
      I('soccer', 'Soccer', 'football ball sport', cir(12, 12, 9), poly(12, 12, 3.2, 5), 'M12 8.8 L12 3.7', 'M15.04 10.81 L19.9 9.4', 'M13.88 14.39 L16.9 18.7', 'M10.12 14.39 L7.1 18.7', 'M8.96 10.81 L4.1 9.4'),
      I('basketball', 'Basketball', 'ball sport hoops', cir(12, 12, 9), 'M3 12 H21', 'M12 3 V21', 'M5.5 5.5 a12 12 0 0 1 0 13', 'M18.5 5.5 a12 12 0 0 0 0 13'),
      I('tennis', 'Tennis', 'ball sport racket', cir(12, 12, 9), 'M4.2 6 c4 2.5 4 9.5 0 12', 'M19.8 6 c-4 2.5 -4 9.5 0 12'),
      I('football', 'Football', 'american sport ball', 'M4 20 C4 12 12 4 20 4 C20 12 12 20 4 20 Z', 'M8.5 15.5 L15.5 8.5', 'M10.2 12.2 l1.6 1.6', 'M12.2 10.2 l1.6 1.6'),
      I('medal', 'Medal', 'award win achievement', cir(12, 15, 5), star(12, 15, 2.6, 1, 5), 'M9 10.8 L6.5 3 H11 L12.5 6.5', 'M15 10.8 L17.5 3 H13'),
      I('chess', 'Chess', 'pawn strategy game', cir(12, 6.5, 3), 'M9.8 9.2 C10 12 9 14 7.5 15.5 H16.5 C15 14 14 12 14.2 9.2', 'M7.5 15.5 L6.5 18.5', 'M16.5 15.5 L17.5 18.5', 'M6.5 18.5 h11 v2.5 h-11 Z'),
      I('bowling', 'Bowling', 'ball pins game', cir(12, 12, 9), cir(10, 9, 1), cir(14.5, 9.5, 1), cir(12.3, 6.7, 1)),
      I('eight-ball', 'Pool', 'billiards eight ball game', cir(12, 12, 9), cir(12, 9.5, 3)),
    ],
  },
  {
    id: 'geometry',
    ...
    icons: [
      ...
      I('heptagon', 'Heptagon', 'shape seven polygon', poly(12, 12, 9.3, 7)),
      I('nonagon', 'Nonagon', 'shape nine polygon', poly(12, 12, 9.3, 9)),
      I('shuriken', 'Shuriken', 'star ninja shape spinner', star(12, 12, 9.5, 3.2, 4, -Math.PI / 4)),
      I('chevron-shape', 'Chevron', 'banner arrow shape direction', 'M3 5 H14 L21 12 L14 19 H3 L9.5 12 Z'),
      I('kite', 'Kite', 'shape diamond quad', 'M12 3 L19 10.5 L12 21 L5 10.5 Z', 'M12 3 V21', 'M5 10.5 H19'),
